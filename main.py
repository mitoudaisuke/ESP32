...
ax2.plot(df["timestamp"],[600]*len(df["timestamp"]), linewidth=1, color="tomato",label="line B(average)")
ax2.plot(df["timestamp"],[600]*len(df["timestamp"]), linewidth=1, color="steelblue",label="line C(average)")
