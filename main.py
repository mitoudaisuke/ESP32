...
ax1.plot(df["timestamp"],[500]*len(df["timestamp"]), linewidth=1, color="tomato",label="line A(average)")
ax1.plot(df["timestamp"],[500]*len(df["timestamp"]), linewidth=1, color="steelblue",label="line A(average)")
